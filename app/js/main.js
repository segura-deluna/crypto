...
/***/ "./src/js/components/_exchange-rates.js":
/*!**********************************************!*\
  !*** ./src/js/components/_exchange-rates.js ***!
  \**********************************************/
/***/ (() => {
...
const renderExchange = (wrapper, data) => {
  ...
  currency.textContent = "".concat(from, "/").concat(to);
...
const hide = (elem, answer) => {
  ...
  answer.style.height = "".concat(answer.offsetHeight, "px");
  answer.offsetHeight;
...
form.addEventListener('submit', event => {
  ...
  fetch('https://api-form-order.herokuapp.com/api/order', {
    ...
    modalTitle.textContent = "".concat(person.name, ", \u0432\u0430\u0448\u0430 \u0437\u0430\u044F\u0432\u043A\u0430 \u0443\u0441\u043F\u0435\u0448\u043D\u043E \u043E\u0442\u043F\u0440\u0430\u0432\u043B\u0435\u043D\u0430, \u043D\u043E\u043C\u0435\u0440: ").concat(person.id);
  });
  form.remove();
  setTimeout(() => {
    overlay.classList.remove('overlay_open');
...
/***/ "./src/js/components/_navigation.js":
/*!******************************************!*\
  !*** ./src/js/components/_navigation.js ***!
  \******************************************/
/***/ (() => {
...
/* harmony import */ var _components_navigation__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/_navigation */ "./src/js/components/_navigation.js");
...
/* harmony import */ var _components_tabs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/_tabs */ "./src/js/components/_tabs.js");
...
/* harmony import */ var _components_exchange_rates__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/_exchange-rates */ "./src/js/components/_exchange-rates.js");
/* harmony import */ var _components_exchange_rates__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_components_exchange_rates__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var _components_faq__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./components/_faq */ "./src/js/components/_faq.js");
